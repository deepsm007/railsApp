...
class OrderListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_list" do
    assert_difference('OrderList.count') do
      post order_lists_url, params: { order_list: { billAmount: @order_list.billAmount, extraToppings: @order_list.extraToppings, name: @order_list.name, prize: @order_list.prize, quantity: @order_list.quantity, size: @order_list.size } }
    end
  ...
  test "should update order_list" do
    patch order_list_url(@order_list), params: { order_list: { billAmount: @order_list.billAmount, extraToppings: @order_list.extraToppings, name: @order_list.name, prize: @order_list.prize, quantity: @order_list.quantity, size: @order_list.size } }
